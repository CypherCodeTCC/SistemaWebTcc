...
import { Button, Container, ContainerCheckoutMobile, FinalizePurchase, FinalizePurchaseBoxMobile, ImageMobile, ImagePaymentMobile, LineMobile, PaymentMobile, PrecoTotalMobile, PrecosMobile, PurchaseInformationMobile, SubTitleMobile, SubTitlePurchaseBoxMobile } from './cartMobileStyle';
            ...
            {totalAmount > 0 ? (
                ...
                <FinalizePurchase>
                    <FinalizePurchaseBoxMobile>
                        ...
                        <SubTitlePurchaseBoxMobile>Finalize suas compras</SubTitlePurchaseBoxMobile>
                    </FinalizePurchaseBoxMobile>
                ...
                <ContainerCheckoutMobile>
                    <PurchaseInformationMobile>
                        ...
                        <PrecosMobile>{taxAmount.toFixed(2)}</PrecosMobile>
                        <SubTitleMobile>Frete</SubTitleMobile>
                        <PrecosMobile>{shippingCost.toFixed(2)}</PrecosMobile>
                        <LineMobile></LineMobile>
                        <SubTitleMobile>Total:</SubTitleMobile>
                        <PrecoTotalMobile>R${(totalAmount + taxAmount + shippingCost).toFixed(2)}</PrecoTotalMobile>
                    </PurchaseInformationMobile>
                    <PaymentMobile>
