    ...
    return (
        <section className="navbar-search">
            <div className="custom-input">
                <svg xmlns="http://www.w3.org/2000/svg" className="svg-icon bi-search" viewBox="0 0 16 16">
...
// Componente Ícones de Carrinho e Login
function CartLoginIcons() {
    return (
        <div className="carrinho-logar">
            <div className="icones">
                {/* Ícone do Carrinho */}
                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 9H11.5585C12.2542 9 12.6021 9 12.864 9.18876C13.1258 9.37752 13.2358 9.70753 13.4558 10.3675L15 15" stroke="black" stroke-linecap="round" />
                    <path d="M35 35H15.7749C14.5086 35 13.8755 35 13.5762 34.5847C13.2769 34.1694 13.4771 33.5688 13.8775 32.3675L14.0883 31.7351C14.5283 30.4151 14.7483 29.755 15.2721 29.3775C15.7959 29 16.4916 29 17.883 29H29" stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M30.6787 29H19.6376C18.3584 29 17.7188 29 17.2178 28.6697C16.7169 28.3394 16.4649 27.7515 15.961 26.5757L12.7922 19.1818C11.9827 17.2929 11.5779 16.3485 12.0225 15.6743C12.4672 15 13.4946 15 15.5496 15H35.8305C38.1295 15 39.279 15 39.7126 15.7471C40.1462 16.4942 39.5758 17.4923 38.4352 19.4884L34.1517 26.9846L34.1517 26.9846C33.5897 27.9679 33.3088 28.4596 32.8432 28.7298C32.3776 29 31.8113 29 30.6787 29Z" stroke="black" stroke-linecap="round" />
